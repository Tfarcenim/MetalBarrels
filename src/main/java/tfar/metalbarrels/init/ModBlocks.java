...
public class ModBlocks {
    ...
    static Block.Properties metal = Block.Properties.of(Material.METAL).strength(1,6).sound(SoundType.METAL).requiresCorrectToolForDrops();
    static Block.Properties obsidian = Block.Properties.of(Material.STONE).strength(2.5f,6000).requiresCorrectToolForDrops();
